...
public class MedidorTipoRestStore implements MedidorTipoStore {
    @Override
    public void getMedidorTipo(final GetMedidorTipoStoreCallBack callback, final Criteria filter) {
        ...
        Call<List<RestMedidorTipo>> getmedidorTipo = service.GetMedidorTipo(3,dt.toDateTime());
        getmedidorTipo.enqueue(new Callback<List<RestMedidorTipo>>() {
            @Override
            public void onResponse(Call<List<RestMedidorTipo>> call, Response<List<RestMedidorTipo>> response) {
                switch (response.code()) {
                    case 200:
                        List<RestMedidorTipo> ListMedidorClaseResponse = response.body();
            ...
            @Override
            public void onFailure(Call<List<RestMedidorTipo>> call, Throwable t) {
