...
public class MedidorMarcaRestStore implements MedidorMarcaStore {
    @Override
    public void getMedidorMarca(final GetMedidorMarcaStoreCallBack callback, final Criteria filter) {
        ...
        Call<List<RestMedidorMarca>> getmedidorMarca = service.GetMedidorMarca(dt.toDateTime());
        getmedidorMarca.enqueue(new Callback<List<RestMedidorMarca>>() {
            @Override
            public void onResponse(Call<List<RestMedidorMarca>> call, Response<List<RestMedidorMarca>> response) {
                switch (response.code()) {
                    case 200:
                        List<RestMedidorMarca> ListMedidorClaseResponse = response.body();
            ...
            @Override
            public void onFailure(Call<List<RestMedidorMarca>> call, Throwable t) {
