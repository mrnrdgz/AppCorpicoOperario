...
public class EmpresaContratistaRestStore implements EmpresaContratistaStore {
    private static EmpresaContratistaRestStore INSTANCE;

    private EmpresaContratistaRestStore() {

    }

    public static EmpresaContratistaRestStore getInstance(){
        if(INSTANCE==null){
            INSTANCE = new EmpresaContratistaRestStore();
        }
        return INSTANCE;
    }
    @Override
    public void getEmpresaContratista(final GetEmpresaContratistaStoreCallBack callback, final Criteria filter) {
