...
public class OrdersFilterPresenter implements Presenter{
    ...
    public OrdersFilterPresenter(GetTipoTrabajo getTipoTrabajo, GetZonas getZonas,View ordersView,UseCaseHandler useCaseHandler) {
    ...
    public void loadTiposTrabajo(String tipoCuadrilla) {
       ...
       // mGetTipoTrabajo.execute(requestValues, useCaseCallback);
        mUseCaseHandler.execute(mGetTipoTrabajo, requestValues, useCaseCallback);
    }
    ...
    public void loadZonas() {
        ...
        mUseCaseHandler.execute(mGetZonas, requestValues, useCaseCallback);
    }
}