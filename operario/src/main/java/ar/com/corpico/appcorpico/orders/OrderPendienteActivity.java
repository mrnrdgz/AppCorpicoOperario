...
public class OrderPendienteActivity extends BaseActivity implements
    ...
    private OrdersListFragment mOrdersView;
    ...
    protected NavDrawerItemMenu getDrawerItem() {
        return NavDrawerItemMenu.PENDIENTES;
    }
    @Override
    ...
    private void iniciarFragmento() {
        ...
        if (mOrdersView == null) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.orders_view_container, mOrdersView, "OrderView")
                    .commit();
    ...
    private void showFragment() {
        ...
        if ((fragmentList instanceof OrdersListFragment)) {
            mOrdersView = OrdersListFragment.newInstance(mTipoCuadrilla, mEstadoArg, mEstadoPostArg, mTipoCuadrillaId, mTiposTrabajoSeleccionados,
                    mZonasSeleccionadas, mFechaInicioSeleccionada, mFechaFinSeleccionada, mSearch, mFieldSort, mObservacion, mLatitud, mLongitud);
            ftList.replace(R.id.orders_view_container, mOrdersView, "OrderView")
                    .commit();
            mOrdersPresenter = new OrdersPresenter(mGetOrders, mAddOrdersState, mOrdersView, mUseCaseHandler);
            mOrdersView.setPresenter(mOrdersPresenter);
        }
        ...
        switch (id) {
            ...
            case R.id.action_list:
                ...
                if (!(fragment1 instanceof OrdersListFragment)) {
                    mOrdersView = OrdersListFragment.newInstance(mTipoCuadrilla, mEstadoArg, mEstadoPostArg, mTipoCuadrillaId, mTiposTrabajoSeleccionados,
                            mZonasSeleccionadas, mFechaInicioSeleccionada, mFechaFinSeleccionada, mSearch, mFieldSort, mObservacion, mLatitud, mLongitud);
                    ft.replace(R.id.orders_view_container, mOrdersView, "OrderView")
                            .commit();
                    mOrdersPresenter = new OrdersPresenter(mGetOrders, mAddOrdersState, mOrdersView, mUseCaseHandler);
                    mOrdersView.setPresenter(mOrdersPresenter);
                }
    ...
    private void handleIntent(Intent intent) {
        if (Intent.ACTION_SEARCH.equals(intent.getAction())) {
            ...
            //TODO: AGREGAR UNA NUEVA INSTANCIA DEL FREGMENTO (REEMPLAZARLLO CON UNA TRANSACCION)
            ...
            mOrdersView.setOrdersParams(mTipoCuadrilla, mEstadoArg, mTiposTrabajoSeleccionados, mZonasSeleccionadas,
                    mFechaInicioSeleccionada, mFechaFinSeleccionada, mSearch, true, mFieldSort);
        }
    }
        ...
        if (requestCode == OPINION_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                if ((fragment1 instanceof OrdersListFragment)) {
                    ...
                    //mOrdersView = OrdersListFragment.newInstance(mTipoCuadrilla, mEstadoArg, mTiposTrabajoSeleccionados,mZonasSeleccionadas, mFechaInicioSeleccionada, mFechaFinSeleccionada,null);
                    mOrdersView = OrdersListFragment.newInstance(mTipoCuadrilla, mEstadoArg, mEstadoPostArg,mTipoCuadrillaId,mTiposTrabajoSeleccionados,
                            mZonasSeleccionadas, mFechaInicioSeleccionada, mFechaFinSeleccionada, mSearch, mFieldSort,mObservacion, mLatitud,mLongitud);
                    ft.replace(R.id.orders_view_container, mOrdersView, "OrderView")
                            .commit();
